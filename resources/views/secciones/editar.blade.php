...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Editar Seccion Legal {{$seccion->titulo}}</div>
                <div class="card-body">
                    <form action="{{route('secciones.actualizar')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="titulo" type="text" class="form-control{{ $errors->has('titulo') ? ' is-invalid' : '' }}" name="titulo" value="{{ $seccion->titulo }}"  autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="imagenCentral" type="file" class="form-control{{ $errors->has('imagenCentral') ? ' is-invalid' : '' }}" name="imagenCentral" value="{{ $seccion->imagenCentral }}"  autofocus>
                        ...
                        <div class="form-group row">
                            <div class="col-md-3 offset-md-3">
                                ...
                                <img src="{{Route('secciones.imagen', ['filename'=>$seccion->imagenCentral])}}" alt="" class="img-thumbnail img-edicion" />
                                @else
                                <p>VACIO</p>
                                @endif
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="descripcionC" type="text" class="form-control{{ $errors->has('descripcionC') ? ' is-invalid' : '' }}" name="descripcionC" value="{{ $seccion->descripcionC }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea type="text" id="descripcionL" name="descripcionL" class="form-control{{ $errors->has('descripcionL') ? ' is-invalid' : '' }}">{{ $seccion->descripcionL }}</textarea>
                        ...
                        <div class="form-group row justify-content-center">
                            <span><i id="mostrar" class="{{$seccion->icono}}}"></i></span>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="icono" id="icono" onchange="iconShow(this)" class="input-text form-control">
                                    <option value="{{$seccion->icono}}"selected>{{$seccion->icono}}</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="metadesc" type="text" class="form-control{{ $errors->has('metadesc') ? ' is-invalid' : '' }}" name="metadesc" value="{{ $seccion->metadesc }}"  autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="metatitle" type="text" class="form-control{{ $errors->has('metatitle') ? ' is-invalid' : '' }}" name="metatitle" value="{{ $seccion->metatitle }}" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="metakey" type="text" class="form-control{{ $errors->has('metakey') ? ' is-invalid' : '' }}" name="metakey" value="{{ $seccion->metakey }}">
